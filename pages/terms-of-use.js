export default function Home() {
    return (
        <div className='terms-of-use'>
            <article>
                <h1>1. Welcome to xPEPEAI.Finance(“we,” “us,” or “our”)the informational resource for xPEPEAI Protocoal, as defined below.</h1>
                <p>Effective Date: November 6th, 2022</p>
                <p> xPEEPAI.Finance provides information and resources about the fundamentals of the decentralized 
                    non-custodial liquidity protocol called the xPEPEAI Protocoal (the “xPEPEAI Protocoal” or “Protocol”). 
                    xPEPEAI.Finance is not one of the available access points to the xPEPEAI Protocoal.
                </p>
                <p> ARBITRATION NOTICE: THESE TERMS (“TERMS”) CONTAIN AN ARBITRATION CLAUSE BELOW. EXCEPT FOR CERTAIN
                    ...
                    INCLUDE OUR VARIOUS WEBSITES, INCLUDING, WITHOUT LIMITATION, xPEPEAI.Finance (AND ANY RESPECTIVE
                    ...
                    THESE TERMS, xPEPEAI.Finance - PRIVACY POLICY (FOUND HERE), AND OTHER POLICIES REFERENCED HEREIN
                ...
                <p>
                    As a condition to accessing or using the Site or Interface, you represent and warrant to xPEPEAI.Finance the following:
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        jurisdiction over xPEPEAI.Finance or you as otherwise duly enacted, 
                ...
                <p>
                    ...
                    Services at contact@xPEPEAI.Finance. When you communicate with us electronically, you consent to
            ...
            <article>
                <h2>xPEPEAI.Finance is provided as an informational resource.</h2>
                <p>xPEPEAI.Finance provides resources about the fundamentals of the 
                    xPEPEAI Protocoal, which is a fully decentralized, community governed 
                    protocol deployed on multiple blockchain networks and systems, and 
                    provides information about the wider xPEPEAI ecosystem, governance, 
                    community, and various interfaces and integrations to the xPEPEAI 
                    ...
                    resource. Because the Site provides information about the xPEPEAI 
                ...
                <h2>We are software developers in the xPEPEAI Protocoal ecosystem.</h2>
                <p>
                    It is important to understand that neither we nor any affiliated entity is a party to any
                    transaction on
                    the blockchain networks underlying the xPEPEAI Protocoal; we do not have possession, custody or
                    control
                    ...
                    when
                    you interact with any xPEPEAI Protocoal smart contracts, you retain control over your cryptoassets
                    at
                ...
                <h2>
                    The xPEPEAI Protocoal is deployed on multiple blockchain-based networks, and we are not responsible
                    for
                    the operation of such networks.
                </h2>
                <p> The software underlying blockchain networks on which the xPEPEAI Protocoal is deployed, including,
                    for
                    ...
                    operation of the blockchain-based software and networks underlying the xPEPEAI Protocoal, (ii) that
                ...
                <h2>xPEPEAI Ecosystem and Community contributors are independent.</h2>
                <p>All community contributors to the ecosystem around the xPEPEAI Protocoal are independent of us, and
                    we
            ...
            <article>
                ...
                <p>Transactions on the xPEPEAI Protocoal rely on smart contracts stored on various blockchains,
                ...
                <p>
                    ...
                    that you will not seek to hold any xPEPEAI.Finance Party responsible for any
                    consequent
                    losses.
                </p>
            ...
            <article>
                ...
                <p>
                    ...
                    materials that you may access or use on or through the Services; however, the code for the xPEPEAI
                    Protocol
                    and the front-end interface (app.xPEPEAI.Finance) deployed on IPFS is open-sourced. Except as
                    expressly set
            ...
            <article>
                ...
                <p>
                    ...
                    EMPLOYEES,
                    AGENTS, REPRESENTATIVES, PARTNERS, AND LICENSORS (COLLECTIVELY, THE “xPEPEAI.Finance INDEMNIFIED
                    PARTIES”)
                    MAKE NO GUARANTEES OF ANY KIND IN CONNECTION WITH THE SERVICES. TO THE MAXIMUM EXTENT PERMITTED
                    UNDER
                    APPLICABLE LAW, THE xPEPEAI.Finance INDEMNIFIED PARTIES DISCLAIM ALL WARRANTIES AND CONDITIONS,
                    WHETHER
                ...
                <ul>
                    ...
                    <li>
                        ...
                        THAT
                        THE xPEPEAI.Finance INDEMNIFIED PARTIES ARE NOT RESPONSIBLE FOR LOSS OR DAMAGE CAUSED BY
                        ANOTHER
                ...
                <p>
                    Limitation of Liability. TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL ANY xPEPEAI.Finance
                ...
                <p>
                    IN ADDITION TO THE FOREGOING, NO xPEPEAI.Finance INDEMNIFIED PARTY SHALL BE LIABLE FOR ANY
                    DAMAGES
                    CAUSED
                ...
                <p>
                    ...
                    WHETHER OR
                    NOT THE xPEPEAI.Finance INDEMNIFIED PARTIES HAVE BEEN INFORMED OF THE POSSIBILITY OF ANY SUCH
                    DAMAGE.
                </p>
                <p>
                    IN NO EVENT WILL THE xPEPEAI.Finance INDEMNIFIED PARTIES’ CUMULATIVE LIABILITY TO YOU OR ANY
                    OTHER
                    USER,
                ...
                <p>
                    UNDER NO CIRCUMSTANCES SHALL ANY xPEPEAI.Finance INDEMNIFIED PARTY BE REQUIRED TO DELIVER TO YOU
                    ANY
                ...
                <p>
                    ...
                    to
                    you. To the extent applicable law does not permit xPEPEAI.Finance Indemnified Parties to
                    disclaim
                    certain
                    warranties or limit certain liabilities, the extent of xPEPEAI.Finance Indemnified Parties’
                    liability and
            ...
            <article>
                ...
                <p>You agree to indemnify, defend, and hold harmless the xPEPEAI.Finance Indemnified Parties from
                    any
                    claim or
            ...
            <article>
                ...
                <p>
                    ...
                    consent to
                    any xPEPEAI.Finance Indemnified Party, or to its successors in the interest of any business
                    associated
            ...
            <article>
                ...
                <p>
                    ...
                    The Agreement (including, without limitation, these Terms, and the xPEPEAI.Finance Privacy
                    Policy)
                    and any
